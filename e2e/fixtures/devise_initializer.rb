...
# Minimal Devise setup — database_authenticatable only. The two seeded account
# holders (Alice, Bob) sign in with email + password at /users/sign_in; the
# Kiosk account-binding surfaces (device verify page, link mint, unlink) then
