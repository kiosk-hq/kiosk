...
Rails.application.routes.draw do
  ...
  # 500. `GET /kiosk/nope/nope` is the 404 probe and it stays one on purpose:
  # kiosk-server's refusal route is a SINGLE constrained segment, so a
  # two-segment path matches nothing at all and Rails composes the answer.
