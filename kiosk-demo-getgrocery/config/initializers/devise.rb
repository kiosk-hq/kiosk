...
# Minimal Devise setup — database_authenticatable only. getgrocery's human
# shopper (Hana) signs in with email + password at /users/sign_in; the Kiosk
# account-binding surfaces (device verify page, link mint, unlink) then
