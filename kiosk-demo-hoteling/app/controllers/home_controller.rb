...
# so an assistant that JSON-POSTs at a human page gets the JSON signpost
# ApplicationController renders. Its job: tell a human/agent visitor what this
# demo is, show live DOMAIN activity (real booking counts),
