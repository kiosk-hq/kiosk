...
class RoomType < ApplicationRecord
  ...
  # three cannot answer differently about the same nights. The overlap test
  # itself belongs to {Booking.overlapping}.
  #
  # `where.not(id: <relation>)` is a NOT IN over a subquery. NOT IN is only safe
  # when the subquery cannot yield NULL, and it cannot: `bookings.room_type_id`
  # is NOT NULL.
