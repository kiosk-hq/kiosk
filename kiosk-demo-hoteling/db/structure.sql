...
--
-- Name: index_bookings_on_room_type_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_bookings_on_room_type_id ON public.bookings USING btree (room_type_id);
...
CREATE INDEX index_room_types_on_property_id ON public.room_types USING btree (property_id);
...
--
-- Name: room_types fk_rails_914384d638; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.room_types
    ADD CONSTRAINT fk_rails_914384d638 FOREIGN KEY (property_id) REFERENCES public.properties(id);


--
-- Name: bookings fk_rails_95b2761688; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: bookings fk_rails_dedb8e6580; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bookings
    ADD CONSTRAINT fk_rails_dedb8e6580 FOREIGN KEY (room_type_id) REFERENCES public.room_types(id);
