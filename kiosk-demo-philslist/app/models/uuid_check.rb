...
#
# philslist takes agent-supplied ids on the wire — the `listing_id` arg of
# edit_listing and close_listing. Its SQL is ActiveRecord throughout since
# K-654, so the SECOND mode below is the operative one here.
#
