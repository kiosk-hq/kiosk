...
class CloseListingOperation
  # Same owner-scoped single statement as {EditListingOperation}, and the same
  # shape guard in front of it (K-581/K-582): a malformed id answers 400, a
  # well-formed foreign one still answers 403.
