...
# Lets the REST wire endpoints (the per-verb pair GET/POST /kiosk/<verb-name>,
# plus /kiosk/pay and /kiosk/schema) authenticate both legacy synthetic tokens AND real
