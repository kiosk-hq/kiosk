...
COMMENT ON TABLE public.reservations IS 'Customer''s reservations. Visible to the user across all of their agents.';
...
--
-- Name: scooters; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE scooters; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON TABLE public.scooters IS 'Scooter fleet. Browse-only via the agent surface.';


--
-- Name: scooters_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: scooters_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: scooters id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: scooters scooters_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: index_reservations_on_scooter_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_reservations_on_scooter_id ON public.reservations USING btree (scooter_id);
...
--
-- Name: reservations fk_rails_84eae71807; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.reservations
    ADD CONSTRAINT fk_rails_84eae71807 FOREIGN KEY (scooter_id) REFERENCES public.scooters(id);
