...
Providers can demand this PoW on any query or action endpoint
(`GET /kiosk/<query-name>`, `POST /kiosk/<action-name>`) — and, as an optional
registration toll, on `/kiosk/auth/register` — at their discretion, via
