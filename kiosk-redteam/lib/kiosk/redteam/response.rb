...
module Kiosk
  module Redteam
    ...
    #   request. It changes what a SECOND 402 means: not "this harness does not
    #   pay tolls" but "the toll was demanded again after it was paid", which is
    #   the difference between a capability gap and a provider behaviour.
    #   Defaults false, so every hand-built Response reads as the un-retried
    #   first answer it is.
