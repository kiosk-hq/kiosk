...
- `Kiosk::Reputation::Policies::RateAndReputation` — shipped EXAMPLE policy: escalates Argon2id difficulty on high request rate, zero purchases, and bad-proof history; providers are expected to replace it.
