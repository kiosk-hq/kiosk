...
- Initial skeleton.
- `Kiosk::TestHelpers::Journey` module — the journey-test DSL from design spec §12: `as_agent_of`, `as_user`, `as_agent`, `as_anonymous`, `query`, `run_action`, `pay_action`, `kiosk_seed`.
